...
import { FloatingLabelContainer, FVTextField } from '../styled'
import { FPDatePicker } from '../styled/date-picker'
      ...
      <FloatingLabelContainer>
        ...
        <FPDatePicker>
          <div
            className='mdp-input'
            onClick={() =>
              this.props.editable ? undefined : this.showDatePicker(true)
            }
          >
            <input
              class='floating-input'
